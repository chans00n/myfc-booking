...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      appointments: {
        Row: {
          ...
          payment_preference: Database["public"]["Enums"]["payment_preference"] | null;
      ...
      intake_forms: {
        Row: {
          ...
          pressure_preference: Database["public"]["Enums"]["pressure_preference"] | null;
    ...
    Enums: {
      ...
      payment_collection_method: "online" | "in_person_card" | "cash" | "check" | "other";
