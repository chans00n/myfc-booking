            ...
            <div key={dayHours.day_of_week} className="space-y-3 py-4 border-b last:border-0">
              ...
              <div className="flex flex-col space-y-3 sm:hidden">
                <div className="flex items-center justify-between">
                  <Label className="font-medium text-sm">{DAYS_OF_WEEK[dayHours.day_of_week]}</Label>
                  <Switch
                    checked={dayHours.is_active}
                    onCheckedChange={(checked) => handleUpdate(dayHours.day_of_week, 'is_active', checked)}
                  />
                </div>
                ...
                {dayHours.is_active && (
                  <div className="flex items-center gap-2">
                    <Input
                      ...
                      onChange={(e) => handleUpdate(dayHours.day_of_week, 'start_time', formatTimeForSave(e.target.value))}
                      className="flex-1"
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) => handleUpdate(dayHours.day_of_week, 'end_time', formatTimeForSave(e.target.value))}
                      className="flex-1"
                    />
                  </div>
                )}
