...
export function ConsultationIntakeForm({ onSubmit, initialData }: ConsultationIntakeFormProps) {
  ...
  const validate = () => {
    ...
    if (!formData.primaryConcerns.trim())
      newErrors.primaryConcerns = "Please describe your primary concerns";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          This free consultation helps us understand your needs and create a personalized massage
          therapy plan.
        </AlertDescription>
      </Alert>
