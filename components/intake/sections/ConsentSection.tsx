  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Please read all consent forms carefully. Your signature indicates that you understand
        ...
        <CardContent className="space-y-4">
          <div className="prose prose-sm max-w-none">
            <p className="text-sm text-muted-foreground">
              I understand that massage therapy is provided for stress reduction, relaxation, 
              relief from muscle tension, and improvement of circulation and energy flow.
            </p>
            
            <p className="text-sm text-muted-foreground">
              I understand that massage therapists do not diagnose illness or disease, 
              prescribe medications, or perform spinal manipulations. I acknowledge that 
              massage therapy is not a substitute for medical examination or diagnosis, 
              and that I should see a physician for any physical ailment.
            </p>

            <p className="text-sm text-muted-foreground">
              I have informed my massage therapist of all my known physical conditions, 
              medical conditions, and medications, and I will keep the massage therapist 
          ...
          {errors.consentAgreements?.informedConsent && (
            <p className="text-sm text-destructive">{errors.consentAgreements.informedConsent.message}</p>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="prose prose-sm max-w-none">
            <p className="text-sm text-muted-foreground">
              I understand that massage therapy may involve physical touch and manipulation 
              of muscles and soft tissues. I acknowledge that there are risks associated 
              with massage therapy, including but not limited to, bruising, soreness, and 
              in rare cases, injury.
            </p>

            <p className="text-sm text-muted-foreground">
              I release the massage therapist and the establishment from any and all 
              liability for any injuries or damages that may occur as a result of the 
              massage therapy session, except in cases of gross negligence or intentional 
              misconduct.
            </p>
          </div>
          ...
          {errors.consentAgreements?.liabilityRelease && (
            <p className="text-sm text-destructive">{errors.consentAgreements.liabilityRelease.message}</p>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="prose prose-sm max-w-none">
            <p className="text-sm text-muted-foreground">
              Your personal and health information will be kept strictly confidential and 
              will only be used for providing you with the best possible care. We will not 
          ...
          {errors.consentAgreements?.privacyPolicy && (
            <p className="text-sm text-destructive">{errors.consentAgreements.privacyPolicy.message}</p>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="prose prose-sm max-w-none">
            <p className="text-sm text-muted-foreground">
              We require 24 hours notice for cancellations or rescheduling. Late 
              cancellations or no-shows may be subject to a cancellation fee. We 
              understand that emergencies happen and will work with you on a 
              case-by-case basis.
            </p>
          </div>
          ...
          {errors.consentAgreements?.cancellationPolicy && (
            <p className="text-sm text-destructive">{errors.consentAgreements.cancellationPolicy.message}</p>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            to all the terms and conditions outlined in this intake form.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <DigitalSignature
