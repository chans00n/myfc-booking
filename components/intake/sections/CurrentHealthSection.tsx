...
const BODY_AREAS = [
  ...
  'Chest', 'Abdomen', 'Hips', 'Arms', 'Hands', 'Legs', 'Feet'
]
...
export function CurrentHealthSection({ form }: CurrentHealthSectionProps) {
  ...
  const removePainArea = (index: number) => {
    setValue('painAreas', painAreas.filter((_, i) => i !== index))
  }
  ...
  const removeMedication = (index: number) => {
    setValue('currentMedications', currentMedications.filter((_, i) => i !== index))
  }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            On average, how would you rate your overall pain level?
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
