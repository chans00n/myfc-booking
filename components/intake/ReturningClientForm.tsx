    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          It's been {daysSinceLastForm} days since your last visit. Please update your health
          information.
        </p>
      </div>
      ...
      <Tabs
        ...
        onValueChange={(v) => setSelectedFormType(v as "quick" | "full")}
      >
          ...
          {lastIntakeForm ? (
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <Button onClick={() => setSelectedFormType("full")}>Complete Full Form</Button>
              </CardContent>
            </Card>
          )}
        </TabsContent>
