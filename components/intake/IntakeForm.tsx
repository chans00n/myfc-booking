...
const intakeFormSchema = z.object({
  ...
  consentAgreements: z.object({
    informedConsent: z
      .boolean()
      .refine((val) => val === true, "You must agree to informed consent"),
    liabilityRelease: z
      .boolean()
      .refine((val) => val === true, "You must agree to liability release"),
    privacyPolicy: z.boolean().refine((val) => val === true, "You must agree to privacy policy"),
    cancellationPolicy: z
      .boolean()
      .refine((val) => val === true, "You must agree to cancellation policy"),
