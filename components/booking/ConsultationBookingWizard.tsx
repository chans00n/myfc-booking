...
const ALL_STEPS: Step[] = [
  ...
  { id: 2, title: 'Consultation Type', description: 'How would you like to meet?', forConsultation: true },
...
export function ConsultationBookingWizard() {
  ...
  const renderStep = () => {
    ...
    switch (currentStep) {
      case 1:
        return <ServiceSelectionEnhanced onValidate={setIsValidStep} preSelectedServiceId={serviceId} />
      case 2:
