        ...
        <Container style={container}>
          ...
          {!hasIntakeForm && reminderType === "24h" && (
            <Section style={ctaSection}>
              ...
              <Text style={text}>Please complete your intake form before your appointment:</Text>
          ...
          <Section>
            ...
            <Text style={text}>• Arrive 5-10 minutes early to settle in</Text>
            <Text style={text}>• Wear comfortable, loose-fitting clothing</Text>
            <Text style={text}>• Stay hydrated before and after your massage</Text>
            <Text style={text}>• Let us know if you have any questions or concerns</Text>
            {!isPaid && paymentAmount > 0 && (
              <>
                {paymentPreference === "pay_at_appointment" && (
                  <Text style={text}>
                    • Payment of ${(paymentAmount / 100).toFixed(2)} will be collected at your
                    appointment
                  </Text>
                )}
                {paymentPreference === "pay_cash" && (
                  <Text style={text}>
                    • Please bring ${(paymentAmount / 100).toFixed(2)} in cash (exact change
                    appreciated)
                  </Text>
                )}
              </>
          ...
          <Text style={footer}>We look forward to seeing you {timeText}!</Text>
        </Container>
      </Body>
    </Html>
  );
