    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Thank you for taking the time to speak with me during our {consultationType}{" "}
            consultation. It was wonderful learning about your wellness goals and discussing how
            massage therapy can support your journey to better health.
          </Text>

          <Text style={text}>
            Based on our conversation, I believe we can make real progress in addressing your
            concerns and helping you feel your best.
          </Text>
          ...
          {specialOfferTitle && (
            <Section style={offerBox}>
              ...
              <Text style={offerText}>
                {specialOfferDescription ||
                  "As a thank you for your consultation, enjoy this exclusive offer on your first appointment!"}
              </Text>
              ...
              <Button style={offerButton} href={bookingUrl}>
                Book Your First Appointment
              </Button>

              <Text style={offerFinePrint}>
                *Offer valid for 30 days from consultation date. Cannot be combined with other
                offers.
              </Text>
            </Section>
          )}
          ...
          <Section style={benefitsSection}>
            ...
            <ul style={list}>
              <li>
                <strong>Personalized Treatment:</strong> Each session is tailored to your specific
                needs
              </li>
              <li>
                <strong>Progress Tracking:</strong> We'll monitor your improvement over time
              </li>
              <li>
                <strong>Flexible Scheduling:</strong> Book appointments that fit your schedule
              </li>
              <li>
                <strong>Ongoing Support:</strong> I'm here to answer questions between sessions
              </li>
            </ul>
          </Section>
          ...
          <Section style={ctaSection}>
            ...
            <Text style={text}>
              Don't wait to start feeling better. Book your first appointment today and take the
            ...
            <Text style={smallText}>Or reply to this email if you have any questions!</Text>
          </Section>
          ...
          <Text style={footer}>
            This email was sent to {clientName} following your recent consultation. If you have any
