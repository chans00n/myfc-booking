    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          {reminderType === '24hour' && (
            <Text style={text}>
              This is a friendly reminder about your free {consultationType} consultation with {therapistName} tomorrow.
            </Text>
          )}
          ...
          {reminderType === '1hour' && (
            <Text style={text}>
              ...
              Please make sure you're ready to {consultationType === 'video' ? 'join the video call' : 'receive our call'}.
            </Text>
          )}
          ...
          {reminderType === '15min' && (
            <Text style={urgentText}>
              ...
              {consultationType === 'video' ? ' Click the button below to join now.' : ' We\'ll be calling you shortly.'}
            </Text>
          )}
