    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={paymentSection}>
            ...
            {isPaid ? (
              ...
              <>
                ...
                {paymentPreference === "pay_at_appointment" && (
                  <Text style={text}>
                    Payment will be collected when you arrive for your appointment. We accept cash,
                ...
                {paymentPreference === "pay_cash" && (
                  <Text style={text}>
                    Please bring ${(paymentAmount / 100).toFixed(2)} in cash to your appointment. We
                    appreciate exact change when possible.
                  </Text>
                )}
              </>
            )}
          ...
          <Text style={footer}>We'll send you a reminder 24 hours before your appointment.</Text>
        </Container>
      </Body>
    </Html>
  );
