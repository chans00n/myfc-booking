...
import { sendBookingConfirmation, sendAppointmentReminder, sendCancellationConfirmation } from '@/lib/notifications/email-service'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const notificationType = type === 'booking' ? 'booking_confirmation' : 
                           type === 'reminder' ? 'appointment_reminder_24h' : 
