            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="sm" onClick={processNotifications}>
                ...
                <Card className="border-orange-200 bg-orange-50">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-2">
                      Email notifications are in development mode. Emails will be logged to the
                      browser console instead of being sent.
                    </p>
                    <p className="text-sm">
                      To send real emails, add{" "}
                      <code className="px-1 py-0.5 bg-orange-100 rounded">RESEND_API_KEY</code> to
                      your <code className="px-1 py-0.5 bg-orange-100 rounded">.env.local</code>{" "}
                ...
                <Card className="border-green-200 bg-green-50">
                  ...
                  <CardContent>
                    <p className="text-sm text-green-700">
                      Email notifications are configured and ready to send. Test emails will be sent
                      to real recipients.
                    </p>
                  </CardContent>
                </Card>
                        ...
                        <TableBody>
                          {notifications.map((notification) => (
                            <TableRow key={notification.id}>
                              ...
                              <TableCell>
                                <Badge
                                  variant={statusColors[notification.status]}
                                  className="gap-1"
                                >
