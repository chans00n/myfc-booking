                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    {consultation.appointment.appointment_date
                      ? format(new Date(consultation.appointment.appointment_date), "MMMM d, yyyy")
                      : "Date not set"}
                  </p>
                </div>
              </div>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        {intakeForm ? (
                          ...
                          <p className="text-muted-foreground">
                            No intake form was submitted for this consultation.
                          </p>
                        )}
                      </CardContent>
                    </Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {consultation.client.date_of_birth && (
                      <div>
                        ...
                        <p className="font-medium mt-1">
                          {consultation.client.date_of_birth
                            ? format(new Date(consultation.client.date_of_birth), "MMMM d, yyyy")
                            : "Not provided"}
                        </p>
                      </div>
                    )}
