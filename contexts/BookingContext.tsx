  ...
  const canProceedToStep = (step: number): boolean => {
    switch (step) {
      ...
      case 5:
        ...
        return !!bookingData.service && !!bookingData.date && !!bookingData.timeSlot && !!bookingData.clientInfo
      case 6:
        // Payment step - only required if pay_now is selected
        if (bookingData.paymentPreference === 'pay_now') {
          return !!bookingData.service && !!bookingData.date && !!bookingData.timeSlot && !!bookingData.clientInfo && !!bookingData.paymentPreference
        }
